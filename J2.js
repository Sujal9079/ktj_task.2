...
Box = document.getElementById("Boxer");
...
function positionTiles(tile, col, row) {
    ...
    if(data[row][col] === reference[(row*size)+ col]){
        tile.style.backgroundColor = "rgba(73,235,247,255)";
    }
    else{
...
function moveTile(tile,row,col){
    ...
    document.getElementById("mowes").innerHTML = moves;
...
function checkWinGame(){
    ...
    if(flag == 1 ){
        ...
        let game = document.getElementById("enter");
...
function updateTime() {
    ...
    document.getElementById("tym").innerHTML = formattedTime
}
